...
public class PartTimeTeacher extends Teacher {
    ...
    public PartTimeTeacher(String name, String lastName, String personalCode, int hourPerMonth, int hourlySalary, Integer experienceYear, Degree degree) {
        super(name, lastName, personalCode, experienceYear, degree);
        this.type = TeacherType.NOT_SET.getVal("part-time");
